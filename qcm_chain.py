...
template = """You are a teacher preparing questions for a quiz. Given the following text, please generate 2 multiple-choice questions (MCQs) with 4 options and a corresponding answer letter based on the text.
...
These questions should be detailed and solely based on the information provided in the text.
...
PROMPT = PromptTemplate(
    input_variables=["text"], template=template, output_parser=output_parser
)
